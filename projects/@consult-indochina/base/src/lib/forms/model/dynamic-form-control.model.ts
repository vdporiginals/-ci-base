...
} from './misc/dynamic-form-control-validation.model';
...
export abstract class DynamicFormControlModel implements DynamicPathable {
  ...
  protected constructor(
    ...
    layout: DynamicFormControlLayout | null = null
  ) {
    ...
    this.disabled$ = new BehaviorSubject(
      isBoolean(config.disabled) ? config.disabled : false
    );
