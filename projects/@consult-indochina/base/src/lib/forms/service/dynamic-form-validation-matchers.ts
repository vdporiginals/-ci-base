...
export type DynamicErrorMessagesMatcher = (
...
export const CHANGE_ERROR_STATE_MATCHER: DynamicErrorMessagesMatcher = (
  ...
  return model.updateOn === DynamicFormHook.Change || model.updateOn === null
    ? control.dirty
    : control.touched && !hasFocus;
};

export const DYNAMIC_ERROR_MESSAGES_MATCHER = new InjectionToken<DynamicErrorMessagesMatcher>(
