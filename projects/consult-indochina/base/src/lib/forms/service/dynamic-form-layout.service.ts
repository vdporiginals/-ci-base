...
export type DynamicFormControlTemplates =
...
export class DynamicFormLayoutService {
  findById(
    id: string,
    formLayout: DynamicFormLayout | null
  ): DynamicFormControlLayout | null {
  ...
  filterTemplatesByModel(
    ...
    const filterCallback: (template: DynamicTemplateDirective) => boolean = (
  ...
  getAlignedTemplate(
    model: DynamicFormControlModel,
    templates: DynamicFormControlTemplates,
    alignment: DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT
  ): DynamicTemplateDirective | undefined {
    return this.filterTemplatesByModel(model, templates).find(
  ...
  getStartTemplate(
    ...
    return this.getAlignedTemplate(
      model,
      templates,
      DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT.Start
    );
  }
  ...
  getEndTemplate(
    ...
    return this.getAlignedTemplate(
      model,
      templates,
      DYNAMIC_TEMPLATE_DIRECTIVE_ALIGNMENT.End
    );
  }
