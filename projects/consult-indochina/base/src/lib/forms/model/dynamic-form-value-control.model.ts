...
export interface DynamicFormValueControlModelConfig<T>
  extends DynamicFormControlModelConfig {
...
export abstract class DynamicFormValueControlModel<
  T
> extends DynamicFormControlModel {
  ...
  protected constructor(
    config: DynamicFormValueControlModelConfig<T>,
    ...
    this.value$ = new BehaviorSubject(config.value ?? null) as any;
  ...
  set value(value: T | null) {
    this.value$.next(value as any);
  }

  getAdditional(key: string, defaultValue?: any | null): any {
    return this.additional !== null && this.additional.hasOwnProperty(key)
      ? this.additional[key]
      : defaultValue;
  }
}
